...
- **SSH**: 접속 방법은 개인 인스턴스와 같습니다. 구성원은 모두 인스턴스의 같은 기본 사용자로 들어갑니다. 구성원이 아닌 사람(수강생 등)에게 인스턴스 안의 특정 계정만 열어 주려면 [게스트 접속](access.md#다른-사람에게-접속-권한-주기-게스트)을 쓰세요. 수업·연구실 단위 절차는 [조교·관리자 가이드](course.md)에 있습니다.
