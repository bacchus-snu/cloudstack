...
**제공할 템플릿과 컴퓨트 오퍼링은 정식 오픈 때 정해서 공지합니다.** 지금 화면에 보이는 것은 시험용입니다. 템플릿과 ISO는 운영진이 등록한 것만 쓸 수 있고 직접 올릴 수는 없습니다. 필요한 운영체제나 이미지가 있으면 <contact@bacchus.snucse.org>로 요청해 주세요.
